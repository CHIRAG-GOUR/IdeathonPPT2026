      ...
      <div className="w-full flex flex-col items-center pb-12">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center w-full max-w-6xl gap-8 pb-12">
          ...
          <div className="flex flex-col gap-6 w-full md:w-1/3 z-10 order-2 md:order-1">
            <motion.div variants={cardVariants} initial="hidden" animate="show" transition={{ delay: 0.6 }} className="glass-card-colorful p-6 rounded-2xl border-l-4 border-l-[#C0C0C0]">
            ...
            <motion.div variants={cardVariants} initial="hidden" animate="show" transition={{ delay: 0.8 }} className="glass-card-colorful p-6 rounded-2xl border-l-4 border-l-[#CD7F32]">
          ...
          <div className="w-full md:w-1/3 h-[300px] md:h-[400px] z-0 flex flex-col items-center justify-center order-1 md:order-2 shrink-0">
            ...
            {/* Added a relatable Kid GIF here */}
            <motion.img 
               initial={{ opacity: 0, y: 20 }}
               animate={{ opacity: 1, y: 0 }}
               transition={{ delay: 1.2 }}
               src="https://media.giphy.com/media/xT0xezQGU5xCDJuCPe/giphy.gif"
               className="w-48 h-auto rounded-xl border border-white/20 shadow-lg mt-4"
               alt="Kids cheering"
            />
          </div>

          {/* Right: 1st Place & Everyone */}
          <div className="flex flex-col gap-6 w-full md:w-1/3 z-10 order-3 md:order-3">
            <motion.div variants={cardVariants} initial="hidden" animate="show" transition={{ delay: 0.4 }} className="glass-card-colorful p-6 md:p-8 rounded-2xl border-t-4 border-t-[#FFD700] md:scale-110 shadow-[0_0_30px_rgba(255,215,0,0.3)]">
            ...
            <motion.div variants={cardVariants} initial="hidden" animate="show" transition={{ delay: 1 }} className="glass-card-colorful p-6 rounded-2xl border-l-4 border-l-brand-green">
